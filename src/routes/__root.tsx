...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Atletas com Dorflex" },
      { name: "description", content: "Painel interativo do grupo Atletas com Dorflex. Acompanhe o ranking, o placar da temporada e as medalhas de conquistas dos atletas participantes." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Atletas com Dorflex" },
      { property: "og:description", content: "Painel interativo do grupo Atletas com Dorflex. Acompanhe o ranking, o placar da temporada e as medalhas de conquistas dos atletas participantes." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Oswald:wght@500;600;700&family=Barlow+Condensed:wght@500;600;700;800&family=Inter:wght@400;500;600;700&display=swap",
      },
